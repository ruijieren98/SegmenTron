...
class DenseSegmentation(SegmentationDataset):
    ...
    def __init__(self, root='datasets/densepass', split='train', mode=None, transform=None, **kwargs):
        super(DenseSegmentation, self).__init__(root, split, mode, transform, **kwargs)
